...
class CatDict(BaseModel):
    ...
    prior_abbreviation: List[GatherCat | Literal["any"]] | MISSING = Field(
        MISSING,
        description="Specifies s_c choices. Read the docs. It's too long for this.",
    )
    can_create_new_cat: CanCreateNewCat | MISSING = Field(
        MISSING,
    ...
    status: List[StatusAny] | MISSING = Field(
        MISSING,
    ...
    group: List[Group] | MISSING = Field(
        MISSING,
    ...
    standing: StandingDict | MISSING = Field(
        MISSING,
    ...
    has_mentor: MentorApprenticeDict | MISSING = Field(
        MISSING,
        description="Set current mentor status",
    )
    has_apprentice: MentorApprenticeDict | MISSING = Field(
        MISSING,
